...
BikeShare = pd.read_csv("C:/Users/alexw/Desktop/Practice_Datasets/Bike_Sharing/hour.csv")
#Remove Dataframe
...
BikeShare['TimeID'] = BikeShare[['WeekdayNo', 'hour']].apply(lambda x: ''.join(x), axis=1)
...
BikeShare[BikeShare['weathersit'] == 4]
BikeShare[BikeShare['Weather'] == 'sunny']
BikeShare.weathersit.value_counts().plot(kind= 'bar')
